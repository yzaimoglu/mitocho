...
func (svc *Service) CreateSiteIfNotExists(name string, privacyPolicy string, imprint string, termsOfService string, domain string, color types.SiteColor, callback string) error {
	site := types.NewSite(name, privacyPolicy, imprint, termsOfService, domain, color, callback)
